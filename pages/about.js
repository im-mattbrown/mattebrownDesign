...
const BIO_TEXT = 'I AM A PRODUCT DESIGNER AND FRONTEND DEVELOPER WITH OVER A DECADE OF WEB DESIGN AND DEVELOPMENT EXPERIENCE. I HAVE WORKED WITH MANY DIFFERENT COMPANIES AS AN AGENCY EMPLOYEE AND OWNER, BRINGING CLIENTS PROJECTS FROM IDEATION TO EXECUTION WITH A KEEN ATTENTION TO DETAIL AND INTUITION FOR GOOD USER EXPERIENCE. MY CAREER HAS SPANNED ACROSS STARTUPS, AGENCIES AND ENTERPRISE COMPANIES.'
...
const COMPANIES = [
  {
    ...
    desc: "A MODERN CREATIVE AGENCY BUILT ON THE THESIS THAT PRODUCTS SHOULD BE MADE FOR HUMANS, BY HUMANS. MONOM STUDIO WAS FOUNDED IN 2025 TO BUILD DIGITAL PRODUCTS AND HELP BUSINESSES IMPROVE THEIR ONLINCE PRESENCE WITH BESPOKE THOUGHTFUL WEBSITES AND WEB APPLICATIONS.",
  ...
  },
  {
    ...
    desc: 'BUILT BY BIG KIDS WITH BIG DREAMS. MOUSE POTATO LAB IS A DESIGN AND DEVELOPMENT AGENCY WITH ONE GOAL IN MIND, TO BUILD THE PRODUCT THAT YOUR UNIQUE USERBASE WANTS TO USE AND MAKE THAT PRODUCT DELIGHTFULLY FUNCTIONAL. MOUSE POATO LAB HAS SUCCESSFULLY LAUNCHED MULTIPLE WEB APP BASED BUSINESSES AND HELPED FOUNDERS GET FROM IDEA TO FUNDING.',
  ...
  },
  {
    ...
    desc: 'LALO IS A PLACE TO REMEMBER. MOST OF US HAVE LOST A LOVED ONE, SOMEONE THAT WAS IMPACTFUL IN YOUR LIFE AND SOMEONE WHOS LEGACY YOU WANT TO PRESERVE. WITH LALO, A MOBILE APPLICATION DESIGNED TO CAPTURE AND PRESERVE THE MEMORIES OF THOSE WHO ARE CLOSEST TO US WETHER THEY ARE STILL HERE OR NOT, USERS CAN CREATE DIGITAL CAPSULES WITH CLOSE FRIENDS AND FAMILY TO PRESERVE PHOTOS, STORIES AND VIDEOS. LALO REACHED OVER 3000 USERS WORLDWIDE BEFORE SHUTTING DOWN IN 2022.',
  ...
  },
  {
    ...
    desc: 'BLACK FLAG CREATIVE partnerS with businesses by providing web design and development services to create high-impact websites. THE expert crew will work closely with CLIENTS to develop a custom web design strategy that aligns with your business goals and attracts THEIR target audience. By focusing on your specific needs, we ensure that your digital presence delivers measurable outcomes. Set sail with our crew to build a powerful website solution that helps your business grow.',
